**The PyCaret k8s Streamlit App**\ :
=============================

Description:
---

This is an update of the `pycaret-deployment-streamlit`_ app, initially generated with `pycaret`_ along with `@moezali1`_'s
`pycaret`_ end-to-end machine learning and model management tool, and with `@kumarvc`_'s `Fastapi-docker-kubernetes-streamlit`_ kubernetes deployment, 
and with `@marcel-dempers`_'s `docker-development-youtube-series`_ The Ultimate Engineer Toolbox.

.. _`pycaret-deployment-streamlit`: https://github.com/pycaret/pycaret-deployment-streamlit
.. _`pycaret`: https://github.com/pycaret/pycaret
.. _`@moezali1`: https://github.com/pycaret/pycaret 
.. _`Fastapi-docker-kubernetes-streamlit`: https://github.com/kumarvc/Fastapi-docker-kubernetes-streamlit
.. _`@kumarvc`: https://github.com/kumarvc/Fastapi-docker-kubernetes-streamlit
.. _`docker-development-youtube-series`: https://github.com/marcel-dempers/docker-development-youtube-series
.. _`@marcel-dempers`: https://github.com/marcel-dempers/docker-development-youtube-series
